...
COVERAGE = (
    ReviewCoverage(
        ...
        "опубликованы",
        36,
        ("reviews/early_fathers/29_gregory_pastoral_rule.md",),
    ),
    ReviewCoverage(
    ...
    ReviewCoverage(
        ...
        "опубликованы",
        36,
        ("reviews/early_fathers/27_seraphim_instructions.md",),
    ),
    ReviewCoverage(
        ...
        "опубликованы",
        36,
        ("reviews/early_fathers/26_tikhon_spiritual_images.md",),
    ),
    ReviewCoverage(
        ...
        "опубликованы",
        36,
        ("reviews/early_fathers/25_ambrose_family_letters.md",),
    ),
    ReviewCoverage(
    ...
    ReviewCoverage(
        ...
        "опубликованы",
        9,
        ("reviews/early_fathers/23_zlatoust_stagirios.md",),
    ),
    ReviewCoverage(
    ...
    ReviewCoverage(
        ...
        30,
        (
            "reviews/early_fathers/18_cassian_001_005.md",
            "reviews/early_fathers/19_cassian_006_010.md",
        ),
    ),
    ReviewCoverage(
